			...
			<div class="container-fluid px-md-0">
    			...
    			<div class="col-lg-6">
    				<div class="room-wrap d-md-flex">
    					<a href="{{route('hotels.rooms.details' , $rooms->id)}}" class="img" style="background-image: url({{asset('assets/images/'.$room->image.'')}});"></a>
    					<div class="half left-arrow d-flex align-items-center">
    						<div class="text p-4 p-xl-5 text-center">
	    						...
	    						<ul class="list-accomodation">
	    							<li><span>Max:</span>{{$room->max_person}}</li>
	    							<li><span>Size:</span>{{$room->size}}</li>
	    							<li><span>View:</span>{{$room->view}}</li>
	    							<li><span>Bed:</span>{{$room->num_beds}}</li>
	    						</ul>
	    						<p class="pt-1"><a href="{{route('hotel.rooms.details' , $rooms->id)}}" class="btn-custom px-3 py-2">View Room Details <span class="icon-long-arrow-right"></span></a></p>
    						</div>
    					</div>
    				</div>
    			</div>
